    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          {voiceEnabled ? (
            <Volume2 className="w-4 h-4 text-[#155dfc]" />
          ) : (
        ...
        <label className="relative inline-flex items-center cursor-pointer">
          ...
          />
          <div className="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-[#155dfc]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[#155dfc]" />
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-2">
              <select
                ...
                className="flex-1 px-3 py-2.5 rounded-xl border border-[#C9DCFF] bg-[#EFF5FF] text-sm outline-none focus:ring-2 focus:ring-[#155dfc]/20 focus:border-[#155dfc] transition-all"
              >
              ...
              <button
                ...
                className="px-3 py-2.5 rounded-xl border border-[#C9DCFF] bg-[#EFF5FF] text-[#155dfc] hover:bg-[#DEEAFF] transition-all disabled:opacity-50 flex items-center gap-1.5"
                title="Test voice"
              >
          ...
          <div>
            ...
            <input
              ...
              className="w-full h-2 bg-[#DEEAFF] rounded-lg appearance-none cursor-pointer accent-[#155dfc]"
            />
        ...
        <div className="flex items-center gap-2 p-3 bg-[#EFF5FF] border border-[#C9DCFF]/60 rounded-lg">
          <Volume2 className="w-4 h-4 text-[#155dfc] flex-shrink-0" />
